...
@section('content')
    <div id="wrapper">
        ...
        <div class="content">
            ...
            @endif
            <form method="POST" name="form_create" class="form-horizontal" id="form_create" action="/backhome/post/store" accept-charset="UTF-8" enctype="multipart/form-data">
                {!! csrf_field() !!}
                    ...
                    <div class="col-lg-9">
                        <div class="hpanel">
                            <div class="panel-body">
                                ...
                                <div class="form-group vhide{{ $errors->has('link') ? ' has-error' : '' }}">
                                    <label class="col-sm-1 control-label">外链</label>
                                    <div class="col-sm-11">
                                        <textarea class="form-control" name="link" cols="50" rows="2" id="link">{!! old('link') !!}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="m-l m-r">
                                    <div class="form-group">
                                        <div class="upImg">
                                            <input type="hidden" name="tempImg" id="tempImg" value="{!!count($errors)>0?old('tempImg'):'/assets/images/defaultImg.png'!!}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="cateid" id="cateid" style="width: 100%">
                                            ...
                                            @foreach($category as $c)
                                                <option value="{!!$c->cateid!!}" @if(old('cateid')==$c->cateid) selected @endif>{!!$c->name!!}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="order" type="text" id="order" value="{!! count($errors)>0?old('order'):$now !!}"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">类型</label>
                                        <select class="form-control" name="type" id="type" style="width: 100%">
                                            <option value="1" @if(old('type') == '1') selected @endif>默认</option>
                                            <option value="2" @if(old('type') == '2') selected @endif>外链</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
